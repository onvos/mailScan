#!/usr/bin/php
<?php
	// /usr/bin/cat /var/log/maillog | grep ": client="
	// the hotmail, gmail, modem and your server ips with 3 of the 4 ip number blocks.
	...
	// get the bad ips, customize with your a b c or d net ips
